...
class ChatAdapter(private val messages: List<ChatMessage>)
    ...
    companion object {
        private val COLOR_META_DEFAULT = Color.parseColor("#8aa0b8")
        private val COLOR_META_ADMIN = Color.parseColor("#86efac")
        private val COLOR_META_CUT = Color.parseColor("#a7f3d0")
        private val COLOR_META_CET = Color.parseColor("#7dd3fc")
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val sideGap = (58 * dm.density + 0.5f).toInt()
        ...
        when (msg.type) {
            ...
            MessageType.ALERT -> {
                ...
                p.marginStart = if (msg.isMine) sideGap else 0
                p.marginEnd = if (msg.isMine) 0 else sideGap
                holder.bubble.layoutParams = p
            }
